...
function DarkraiX:Window(text,gamenme,logo,keybind)
	...
	Logo.Image = "http://www.roblox.com/asset/?id=12523036534"
	...
	BindButton.Text = tostring(game.Players.LocalPlayer.Name)
	spawn(function()
            while wait() do
                pcall(function()
                    wait(0.1) 
                    game:GetService('TweenService'):Create(
                        BindButton,TweenInfo.new(1,Enum.EasingStyle.Linear,Enum.EasingDirection.InOut),
	...
	function uitab:AddTab(text)
	    ...
	    TabButton.BorderColor3 = Color3.fromRGB(7, 236, 240)
...
local Library = DarkraiX:Window("        Lol HUB","Blox Fruit | Version Free ","DarkRaiGui",Enum.KeyCode.RightControl);
...
H:AddLabel("Wellcone To Script Lol Hub")

H:AddSeperator("Credit")


H:AddButton("Copy Link Donate Click Free Access",function()
setclipboard("https://direct-link.net/547536/donate-Lol-hubลิ้งโดเนท")
end)

H:AddButton("Copy Youtube Lol Hub",function()
...
Main:AddToggle("By Pass Tp",_G.BypassTp,function(Fast)
BypassTP = Fast
end)
...
game.StarterGui:SetCore("SendNotification", {
      Icon = "http://www.roblox.com/asset/?id=12523036534";
      Title = "Lol Hub", 
      Text = "made by @miidraayeerng มีดร้ายแรงคนเดิม";
})
