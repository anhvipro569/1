...
local Library = DarkraiX:Window("A HUB","Blox Fruit | Version Premium NoKey","DarkRaiGui",Enum.KeyCode.RightControl);

local Main = Library:AddTab("Main","")
local Farm = Library:AddTab("Farm/Quest","")
local Stats = Library:AddTab("Stats","")
local Combat = Library:AddTab("Combat","")
local Teleport = Library:AddTab("Islands","")
local Dungeon = Library:AddTab("Dungeon","")
local Fruit = Library:AddTab("Fruit","")
local Shop = Library:AddTab("Shop","")
local Misc = Library:AddTab("Misc","")
local RaceV4 = Library:AddTab("Racev4","")
...
Main:AddButton("Boost Your FPS", function()
...
Main:AddButton("Rejoin Server", "Rejoin on Server", function()
game:GetService("TeleportService"):Teleport(game.PlaceId, game:GetService("Players").LocalPlayer)
end)

Main:AddButton("servers Hop", function()
Hop()
end)
function Hop()
...
Main:AddButton("Server Hop Lower Server",function()
...
Main:AddDropdown("Fast Attack Mode", AttackList,function(adl)
...
Main:AddDropdown("Select Farm Type", FarmTable,function(value)
 AutoFarmType = value
end)
spawn(function()
 while wait(.1) do
...
DisFarm = 35
Main:AddSlider("Farm Distance",1,100,35,function(value)
DisFarm = value
end)
else
DisFarm = 35
...
Main:AddToggle('Bypass TeTeleport', BypassTP, function(vale)
BypassTP = vale
end)

_G.FastAttack = true
Main:AddToggle('Fast Attack', _G.FastAttack, function(famobile)
...
Main:AddToggle("Auto Set Spawn Point",true, function(setspawnfunc)
...
Main:AddToggle("Auto Buso Haki",true, function(busohakifunc)
...
Main:AddSeperator("🗡️ Main Farm 🗡️")
--// main farming
...
Main:AddToggle("Anti Cheat Bypass", true, function(value)
_G.SafeFarm = value
CheckAntiCheatBypass()
...
Main:AddToggle("Farm Selected Mode",_G.Auto_Farm_Level,function(value)
...
if World1 then
 Main:AddToggle('Auto Second World', AutoSecondSea, function(scfunc)
...
if World2 then
 Main:AddToggle('Auto Third World', AutoThirdSea, function(thirdfunc)
...
if World2 then
Main:AddToggle('Auto Ectoplasm', AutoEcto, function(aef)
 AutoEcto = aef
...
Main:AddToggle("Auto Farm Chest (Tween)",false,function(t)
...
Main:AddToggle('Auto Farm Instant + Hop', _G.GrabChested, function(gacf)
_G.GrabChested = gacf
end)
...
Main:AddToggle("Auto Farm Bone",AutoFarmBone, function(bonefarn)
...
Main:AddToggle("Auto Trade Bone",_G.Auto_Trade_Bone,function(value)
...
Main:AddToggle('Auto Try Luck', TryLuck, function(gravefunc)
     TryLuck = gravefunc
 
 end)
 Main:AddToggle('Auto Pray', TryLuck, function(prayfunc)
     Pray = prayfunc
...
Main:AddSeperator("Other Mobs")

Main:AddDropdown("Select Monster",tableMon,{""}, function(monsterlistfunc)
SelectMonster = monsterlistfunc
end)

Main:AddToggle("Auto Farm Select Monster (Quest)", AutoFarmSelectMonsterQuest, function(smq)
...
Main:AddToggle("Auto Farm Select Monster (No Quest)", AutoFarmSelectMonsterNoQuest, function(smnq)
...
Main:AddDropdown('Select Material', MaterialList,function(matelist)
SelectMaterial = matelist
end)

Main:AddToggle('Auto Farm Material',AutoFarmMaterial, function(automatefunc)
...
--// Boss Farming
local BossStatus = Main:AddLabel("")
local BossQuest = Main:AddLabel("")
...
local selectedBoss = Main:AddDropdown('Select Boss', Boss,function(bosslist)
SelectBoss = bosslist
end)
...
Main:AddToggle('Auto Farm Boss (Quest)', AutoFarmBossQuest, function(afbq)
...
Main:AddToggle('Auto Farm Boss (No Quest)', toFarmBossNoQuest, function(afbnq)
...
Main:AddDropdown('Select type', MasteryType,function(typefunc)
TypeMastery = typefunc
end)

Main:AddToggle("Auto Farm Mastery (Devil Fruit)", AutoFarmMasDevilFruit, function(dfm)
...
Main:AddToggle("Auto Farm Mastery (Gun)",AutoFarmMasGun, function(gmf)
AutoFarmMasGun = gmf
SelectMonster = nil
...
KillPercent = 25
Main:AddSlider('Kill Mobs At Health min ... %',1,100,25, function(KillPercentfunc)
...
SkillV = true
SkillF = true
Main:AddToggle('Use Skill Z',SkillZ, function(zfunc)
SkillZ = zfunc
end)

Main:AddToggle('Use Skill X', SkillX, function(xfunc)
SkillX = xfunc
end)

Main:AddToggle('Use Skill C', SkillC, function(cfunc)
SkillC = cfunc
end)

Main:AddToggle('Use Skill V', SkillV, function(vfunc)
SkillV = vfunc
end)

Main:AddToggle('Use Skill F', SkillF, function(ffunc)
SkillF = ffunc
end)

 Main:AddSeperator("🤺 Observation Haki 🤺")
...
Main:AddToggle('Auto Farm Observation', false, function(autokenf)
...
if Worl3 then
Main:AddToggle('Auto Observation V2', false, function(autokenv2f)
 AutoKenV2 = autokenv2f
 CancelTween(AutoKenV2)
end)

Main:AddToggle('Auto Observation V2 Hop', false, function(kenhopf)
 AutoKenHop = kenhopf
end)
...
Farm:AddSeperator("Fighting Style")

Farm:AddToggle('Auto Death Step', AutoDeathStep, function(ads)
 AutoDeathStep = ads
...
Farm:AddToggle('Auto Super Human', AutoSuperhuman, function(autosuperhumanfunc)
...
Farm:AddToggle('Auto Sharkman Karate', AutoSharkman, function(autosharkfunc)
...
Farm:AddToggle('Auto Electric Claw', AutoElectricClaw, function(autoelectfunc)
...
Farm:AddToggle('Auto Dragon Talon', AutoDragonTalon, function(autodtfunc)
...
Farm:AddToggle('Auto God Human', AutoGodhuman, function(autogodhumanfunc)
...
Farm:AddToggle('Auto Cake Prince', AutoCakePrince, function(autocakefunc)
...
Farm:AddSeperator("👾 Elite Hunter 👾")
local EliteProgress = Farm:AddLabel("")
 ...
 Farm:AddToggle('Auto Elite Hunter', AutoEliteHunter, function(autoelitefunc)
...
if World2 then
Farm:AddSeperator("🗡️ Auto Rengoku 🗡️")

Farm:AddToggle('Auto Rengoku', AutoRengoku, function(autorengokufunc)
 AutoRengoku = autorengokufunc
 CancelTween(AutoRengoku)
end)
Farm:AddToggle('Auto Rengoku [HOP]', false, function(value)
Hop()
end)
spawn(function()
 while task.wait() do
...
if World3 then
Farm:AddSeperator("🗡️ Buddy Sword 🗡️")

local queen = Farm:AddLabel("")
...
Farm:AddToggle('Auto Buddy Sword', AutoBuddySword, function(autobuddyswordfunc)
...
Farm:AddToggle('Auto Buddy Sword [HOP]', false, function(value)
 Hop()
end)
end

if World1 then
Farm:AddSeperator("🗡️ Pole Sword 🗡️")

local pole = Farm:AddLabel("")
...
Farm:AddToggle('Auto Pole', AutoPole, function(autopolefunc)
...
Farm:AddToggle('Auto Pole [HOP]' , false, function(value)
 Hop()
end)
end
if World3 then
Farm:AddSeperator("🗡️ Yama Sword 🗡️")

local Total_Elite_Hunter = Farm:AddLabel("")
...
Farm:AddToggle('Auto Yama' , AutoYama, function(autoyamafunc)
...
Farm:AddSeperator("⛏️ Hallow Sycthe ⛏️")

local hallow = Farm:AddLabel("")
if game:GetService("Workspace").Enemies:FindFirstChild("Soul Reaper [Lv. 2100] [Raid Boss]") then
hallow:Set("Status : Soul Reaper Boss Has Been Spawn ✅")
else
hallow:Set("Status : Soul Reaper Boss Not Spawn ❌")
end
Farm:AddToggle('Auto Hallow Sycthe', AutoHallowSycthe, function(autohallowsycthefunc)
...
Farm:AddToggle('Auto Hallow Sycthe [HOP]', false, function(value)
Hop()
end)

Farm:AddSeperator("🗡️ Cavander Sword 🗡️")
local cavander = Farm:AddLabel("")
if game:GetService("Workspace").Enemies:FindFirstChild("Beautiful Pirate [Lv. 1950] [Boss]") then
cavander:Set("Status : Beautiful Pirate Has Been Spawn ✅")
else
cavander:Set("Status : Beautiful Pirate Not Spawn ❌")
end
Farm:AddToggle('Auto Cavander', AutoCavander, function(autocavanderfunc)
...
Farm:AddToggle('Auto Canvander [HOP]', false, function(value)
Hop()
end)

Farm:AddSeperator("🗡️ Tushita Sword 🗡️")

Farm:AddToggle('Auto Tushita', AutoTushita, function(autotushitafunc)
...
Farm:AddToggle('Auto Tushita [HOP]', false, function(value)
Hop()
end)

Farm:AddSeperator("🔪 Dark Dagger 🔪")

Farm:AddToggle('Auto Dark Dagger', AutoDarkDagger, function(autodarkdaggerfunc)
...
Farm:AddToggle('Auto Dark Dagger [HOP]', false, function(value)
Hop()
end)

Farm:AddSeperator("⚔️ Dual Cursed Katana ⚔️")

local Yama = Farm:AddLabel("❌ : Yama")

local Tushita = Farm:AddLabel("❌ : Tushita")
...
Farm:AddToggle('Auto Cursed Dual Katana', false, function(autocdkf)
 ...
 Farm:AddToggle('Auto Dual Cursed Katana [HOP]', false, function(value)
Hop()
end)
 
 Farm:AddSeperator("🎸 Soul Guitar 🎸")

 Farm:AddToggle('Auto Soul Guitar', false, function(soulguiutarf)
...
Farm:AddToggle('Auto Soul Guitar [HOP]', false, function(value)
Hop()
end)


Farm:AddSeperator("🏹 Serpent Bow 🏹")

local serpent = Farm:AddLabel("")
if game.Workspace.Enemies:FindFirstChild("Island Empress [Lv. 1675] [Boss]") then
serpent:Set("Status : Island Impress Boss Has Been Spawn ✅")
else
serpent:Set("Status : Island Impress Boss Not Spawn ❌")
end
Farm:AddToggle('Auto Serpent Bow', false, function(asbgh)
...
Farm:AddToggle('Auto Serpent Bow [HOP]', false, function(value)
Hop()
end)
end

if World1 then
Farm:AddSeperator("🗡️ Saber Sword 🗡️")
 Farm:AddToggle('Auto Saber', false, function(autosaberfunc)
 ...
 Farm:AddToggle('Auto Saber [HOP]', false, function(value)
Hop()
end)
end

Farm:AddSeperator("📜 Other Quest 📜")

if World2 then
Farm:AddToggle('Auto Citizen', AutoCitizen, function(aef)
 AutoCitizen = aef
...
Farm:AddToggle('Auto Evo Race', AutoEvoRace, function(aef)
 AutoEvoRace = aef
...
Farm:AddToggle('Auto Bartilo', AutoBartilo, function(aef)
 AutoBartilo = aef
...
Farm:AddToggle('Auto Farm Factory', AutoFactory, function(aef)
 AutoFactory = aef
...
if World3 then
 Farm:AddToggle('Auto Rip Indra', false, function(ripindraf)
     RipIndra = ripindraf
 ...
 Farm:AddToggle('Auto Rainbow Haki', false, function(autorainbowfunc)
 ...
 Farm:AddToggle('Auto Holy Torch', false, function(holytorchf)
...
Farm:AddToggle("Auto Phoenix Dungeon", false, function(value)
...
Farm:AddToggle('Auto Legendary Sword', false, function(autolegendsw)
...
Farm:AddToggle('Auto Enchancement Haki', false, function(autocolorhk)
...
Farm:AddToggle('Auto Musketer', false, function(musketerfu)
...
if World2 then
 Farm:AddToggle("Auto Don Swan", false, function(donswanfunc)
...
Stats:AddToggle("Auto Stats Kaitun",_G.Auto_Stats_Kaitun,function(value)
...
Stats:AddToggle("Auto Stats Melee",_G.Auto_Stats_Melee,function(value)
...
Stats:AddToggle("Auto Stats Defense",_G.Auto_Stats_Defense,function(value)
...
Stats:AddToggle("Auto Stats Sword",_G.Auto_Stats_Sword,function(value)
...
Stats:AddToggle("Auto Stats Gun",_G.Auto_Stats_Gun,function(value)
...
Stats:AddToggle("Auto Stats Devil Fruit",_G.Auto_Stats_Devil_Fruit,function(value)
...
Stats:AddButton("Stat Refund",function()
...
return "Point : " .. tostring(value)
 ...
 Stats:AddToggle("Enabled Fake",false,function(value)
...
Combat:AddSeperator("🤺 Players Combat 🤺")
PlayerList = {}
...
local SelectedPly = Combat:AddDropdown('Player List', PlayerList,function(SelectPlyfunc)
 SelectPly = SelectPlyfunc
end)

Combat:AddButton('Refresh Player List',function()
 NewPlayerList = {}
 for i,v in pairs(game.Players:GetChildren()) do  
...
Combat:AddToggle('Aimbot Skill', false, function(ambotskillfunc)
 AimbotSkill = aimskillfunc
end)

Combat:AddToggle("Aimbot Skill Nearest", false, function(vu)
...
Combat:AddToggle('Aimbot Gun', false, function(aimbotgunfunc)
...
Combat:AddToggle('Teleport to Player', false, function(tptoplf)
...
Combat:AddToggle('Spectated Player', false, function(spectafunc)
...
Combat:AddToggle('Kill Player with Melee', false, function(killplayermeleefunc)
...
Combat:AddToggle('Kill Player with Devil Fruit', false, function(killplayfruitfunc)
...
Combat:AddToggle('Kill Player with Gun', false, function(killplaygunfunc)
...
Combat:AddSeperator("📈 Player Status 📈")

Combat:AddLabel("Name : "..game.Players.LocalPlayer.Name)


if World1 then
Combat:AddLabel("World : 1")
end

if World2 then
Combat:AddLabel("World : 2")
end

if World3 then
Combat:AddLabel("World : 3")
end

Combat:AddLabel("Race : "..game:GetService("Players").LocalPlayer.Data.Race.Value)

Combat:AddLabel("Fruit : "..game.Players.LocalPlayer.Data.DevilFruit.Value)

Combat:AddLabel("Level : "..game.Players.localPlayer.Data.Level.Value)

Combat:AddLabel("Bounty : "..game:GetService("Players").LocalPlayer.leaderstats["Bounty/Honor"].Value)

Combat:AddSeperator("🗡️ Sword 🗡️")

local Saber = Combat:AddLabel("❌ : Saber")
local Rengoku = Combat:AddLabel("❌ : Rengoku")
local Midnight_Blade = Combat:AddLabel("❌ : Midnight Blade")
local Dragon_Trident = Combat:AddLabel("❌ : Dragon Trident")
local Yama = Combat:AddLabel("❌ : Yama")
local Buddy_Sword = Combat:AddLabel("❌ : Buddy Sword")
local Canvander = Combat:AddLabel("❌ : Canvander")
local Twin_Hooks = Combat:AddLabel("❌ : Twin Hooks")
local Spikey_Trident = Combat:AddLabel("❌ : Spikey Trident")
local Hallow_Scythe = Combat:AddLabel("❌ : Hallow Scythe")
local Dark_Dagger = Combat:AddLabel("❌ : Dark Dagger")
local Tushita = Combat:AddLabel("❌ : Tushita")
...
Combat:AddSeperator("🗡️ Quest 🗡️")

local Bartilo_Quest = Combat:AddLabel("❌ : Bartilo Quest")
local Don_Swan_Quest = Combat:AddLabel("❌ : Don Swan Quest")
local Kill_Don_Swan = Combat:AddLabel("❌ : Kill Don Swan")
...
Combat:AddSeperator("🗡️ Sword Legendary 🗡️")

local Shisui = Combat:AddLabel("❌ : Shisui")
local Saddi = Combat:AddLabel("❌ : Saddi")
local Wando = Combat:AddLabel("❌ : Wando")
local True_Triple_Katana = Combat:AddLabel("❌ : True Triple Katana")
...
Combat:AddSeperator("🔪 Melee 🔪")

local Superhuman = Combat:AddLabel("❌ : Superhuman")
local Death_Step = Combat:AddLabel("❌ : Death Step")
local Sharkman_Karate = Combat:AddLabel("❌ : Sharkman Karate")
local Electric_Claw = Combat:AddLabel("❌ : Electric Claw")
local Dragon_Talon = Combat:AddLabel("❌ : Dragon Talon")
local God_Human = Combat:AddLabel("❌ : God Human")
...
Combat:AddSeperator("🔫 Gun 🔫")

local Kabu_cha = Combat:AddLabel("❌ : Kabucha")
local Acidum_Rifle = Combat:AddLabel("❌ : Acidum Rifle")
local Bizarre_Rifle = Combat:AddLabel("❌ : Bizarre Rifle")
...
Combat:AddSeperator("⚙️ Accessory ⚙️")

local Dark_Coat = Combat:AddLabel("❌ : Dark Coat")
local Ghoul_Mask = Combat:AddLabel("❌ : Ghoul Mask")
local Swan_Glass = Combat:AddLabel("❌ : Swan Glass")
local Pale_Scarf = Combat:AddLabel("❌ : Pale Scarf")
local Valkyrie_Helm = Combat:AddLabel("❌ : Valkyrie Helm")
...
if World3 then
Teleport:AddSeperator("🏝️ Mirage Island 🏝️")

local FM = Teleport:AddLabel('Go to Third Sea Pls!!')
local Mirragecheck = Teleport:AddLabel('Go to Third Sea pls!!')
...
Teleport:AddToggle("Teleport Mirage Island",false,function(value)
_G.Mirage = value
StopTween(_G.Mirage)
end)

Teleport:AddToggle("Auto Mirage Island [HOP]",false,function(value)
_G.MirageHop = value
end)
Teleport:AddToggle("Teleport To Gear[Beta]",false,function(value)
...
Teleport:AddSeperator("🗺️ World - Server 🗺️")

Teleport:AddButton("Hop Server",function()
 local PlaceID = game.PlaceId
 local AllIDs = {}
 local foundAnything = ""
 local actualHour = os.date("!*t").hour
...
Teleport:AddButton("Teleport to Third Sea", function()
 ...
 Teleport:AddSeperator("👤 NPC Teleport 👤")
...
if World1 then
 ...
 Teleport:AddToggle("Teleport",_G.TeleportNPC,function(value)
...
Teleport:AddSeperator("🏝️ Island Teleport 🏝️")
...
Teleport:AddButton('Sea Beast', function()
...
if World1 then
 ...
 Teleport:AddButton("Sky island 1 ",function()
     if BypassTP then
 ...
 Teleport:AddButton("Sky island 2 ",function()
     if BypassTP then
 ...
 Teleport:AddButton("Sky island 3 ",function()
     if BypassTP then
 ...
 Teleport:AddButton("Sky island 4 ",function()
     if BypassTP then
...
elseif World2 then
 ...
 Teleport:AddButton("Grave Island",function()
     if BypassTP then
 ...
 Teleport:AddButton("Ice Castle",function()
     if BypassTP then
...
elseif World3 then
 ...
 Teleport:AddButton("Teler Park",function()
     if BypassTP then
 ...
 Teleport:AddButton("Peanut Island",function()
     if BypassTP then
 ...
 Teleport:AddButton("Chocolate Island",function()
     if BypassTP then
 ...
 Teleport:AddButton("Ice Cream Island",function()
     if BypassTP then
 ...
 Teleport:AddButton("Cake Loaf",function()
     if BypassTP then
 ...
 Teleport:AddButton("Candy Cane",function()
     if BypassTP then
 ...
 Teleport:AddButton("Raid Lab",function()
     if BypassTP then
 ...
 Teleport:AddButton("Mini Sky",function()
     if BypassTP then
...
if World1 then
 Dungeon:AddLabel("Umm Do Not Dungeon World First 1")
end

if World2 or World3 then
 local TimeRaid = Dungeon:AddLabel("Use in Raid First!")
...
Dungeon:AddToggle("Auto Farm Kill Mob",_G.Raid,function(kill)
 _G.Raid = kill
 StopTween(_G.Raid)
end)
...
Dungeon:AddToggle("Auto Raid",_G.Auto_Raid,function(vu)
 _G.Auto_Raid = vu
 StopTween(_G.Auto_Raid)
end)

Dungeon:AddToggle("Auto Raid Hop",_G.Auto_Raid_Hop,function(vu)
 _G.Auto_Raid_Hop = vu
end)

Dungeon:AddToggle("Next Islands",_G.Next_Islands,function(vu)
 _G.Next_Islands = vu
...
Dungeon:AddSeperator("Esp Menus")

Dungeon:AddToggle('Chest ESP', false, function(ce)
 ChestESP = ce
end)
spawn(function()
 while wait() do
...
Dungeon:AddToggle('Player ESP', false, function(pe)
 PlayerESP = pe
end)
spawn(function()
 while wait() do
...
Dungeon:AddToggle('Devil Fruit ESP', _G.ESPDF, function(dfespf)
 _G.ESPDF = dfespf
end)
spawn(function()
 while wait(.1) do
...
Dungeon:AddToggle('Fruit ESP', false, function(fec)
 FruitESPe = fec
end)
spawn(function()
 while task.wait() do
...
Dungeon:AddToggle('Island ESP', false, function(ies)
 IslandESP = ies
end)
spawn(function()
 while wait() do
...
Dungeon:AddToggle('Npc ESP', false, function(nec)
 NpcESP = nec
end)
spawn(function()
 while wait() do
...
Fruit:AddToggle("Get Fruit Inventory",_G.Get_Fruit,function(vu)
 _G.Get_Fruit = vu
end)
spawn(function()
 while wait(.5) do
...
Fruit:AddToggle("Auto Bring Fruit",_G.AutoBringFruit,function(value)
...
Fruit:AddToggle("Teleport To Spawn Fruit",false,function(value)
_G.Grabfruit = value
end)
...
spawn(function()
 ...
 Shop:AddButton("Buy Geppo [ $10,000 Beli ]",function()
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Geppo")
 end)
 
 Shop:AddButton("Buy Buso Haki [ $25,000 Beli ]",function()
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Buso")
 end)
 
 Shop:AddButton("Buy Soru [ $25,000 Beli ]",function()
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Soru")
 end)
 
 Shop:AddButton("Buy Observation Haki [ $750,000 Beli ]",function()
...
Shop:AddButton("Buy Boat",function()
 ...
 Shop:AddButton("Buy Black Leg [ $150,000 Beli ]",function()
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyBlackLeg")
 end)
 
 Shop:AddButton("Buy Electro [ $550,000 Beli ]",function()
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectro")
 end)
 
 Shop:AddButton("Buy Fishman Karate [ $750,000 Beli ]",function()
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyFishmanKarate")
 end)
 
 Shop:AddButton("Buy Dragon Claw [ $1,500 Fragments ]",function()
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","1")
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","2")
 end)
 
 Shop:AddButton("Buy Superhuman [ $3,000,000 Beli ]",function()
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman")
 end)
 
 Shop:AddButton("Buy Death Step [ $5,000 Fragments $5,000,000 Beli ]",function()
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDeathStep")
 end)
 
 Shop:AddButton("Buy Sharkman Karate [ $5,000 Fragments $2,500,000 Beli ]",function()
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate",true)
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate")
 end)
 
 Shop:AddButton("Buy Electric Claw [ $5,000 Fragments $3,000,000 Beli ]",function()
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw")
 end)
 
 Shop:AddButton("Buy Dragon Talon [ $5,000 Fragments $3,000,000 Beli ]",function()
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDragonTalon")
 end)

 Shop:AddButton("Buy God Human [ $5,000 Fragments $5,000,000 Beli ]",function()
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyGodhuman")
 end)
 -----Shop----------------
 ...
 Shop:AddButton("Cutlass [ $1,000 Beli ]",function()
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Cutlass")
 end)

 Shop:AddButton("Katana [ $1,000 Beli ]",function()
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Katana")
 end)
 
 Shop:AddButton("Iron Mace [ $25,000 Beli ]",function()
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Iron Mace")
 end)
 
 Shop:AddButton("Dual Katana [ $12,000 Beli ]",function()
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Duel Katana")
 end)
 
 Shop:AddButton("Triple Katana [ $60,000 Beli ]", function()
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Triple Katana")
 end)
 
 Shop:AddButton("Pipe [ $100,000 Beli ]",function()
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Pipe")
 end)
 
 Shop:AddButton("Dual-Headed Blade [ $400,000 Beli ]",function()
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Dual-Headed Blade")
 end)
 
 Shop:AddButton("Bisento [ $1,200,000 Beli ]",function()
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Bisento")
 end)
 
 Shop:AddButton("Soul Cane [ $750,000 Beli ]",function()
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Soul Cane")
 end)

 Shop:AddButton("Pole v.2 [ 5,000 Fragments ]",function()
     game.ReplicatedStorage.Remotes.CommF_:InvokeServer("ThunderGodTalk")
 end)

 Shop:AddToggle("Yama Sword [ Elite Hunter 30 ]",_G.AutoYama,function(value)
     _G.AutoYama = value
 end)
 ...
 Shop:AddButton("Slingshot [ $5,000 Beli ]",function()
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Slingshot")
 end)
 
 Shop:AddButton("Musket [ $8,000 Beli ]",function()
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Musket")
 end)
 
 Shop:AddButton("Flintlock [ $10,500 Beli ]",function()
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Flintlock")
 end)
 
 Shop:AddButton("Refined Slingshot [ $30,000 Beli ]",function()
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Refined Flintlock")
 end)
 
 Shop:AddButton("Refined Flintlock [ $65,000 Beli ]",function()
     local args = {
         [1] = "BuyItem",
         [2] = "Refined Flintlock"
     }
 ...
 Shop:AddButton("Cannon [ $100,000 Beli ]",function()
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Cannon")
 end)
 
 Shop:AddButton("Kabucha [ 1,500 Fragments]",function()
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Slingshot","1")
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Slingshot","2")
 end)

       Shop:AddButton("Bizarre Rifle [ 250 Ectoplasm ]", function()
                                 local A_1 = "Ectoplasm"
                                 local A_2 = "Buy"
                                 local A_3 = 1
 ...
 Shop:AddButton("Buy Surprise [ $50 Bone ]",function()
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Bones","Buy",1,1)
 end)
 
 Shop:AddButton("Stat Refund [ $50 Bone ]",function()
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Bones","Buy",1,2)
 end)
     
 Shop:AddButton("Race Reroll [ $50 Bone ]",function()
     game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Bones","Buy",1,3)
 end)
 
 ------------Stat------------------
 
 Shop:AddSeperator("📊 Stat 📊")
...
Shop:AddButton("Random Race (Use 3K Fragments)", function()
 ...
 --------------Accessories-----------------
     Shop:AddSeperator("⚙️ Accessories ⚙️")
 Shop:AddButton("Black Cape [ $50,000 Beli ]",function()
     local args = {
         [1] = "BuyItem",
         [2] = "Black Cape"
     }
 ...
 Shop:AddButton("Swordsman Hat [ 150k Beli ]",function()
     local args = {
         [1] = "BuyItem",
         [2] = "Swordsman Hat"
     }
 ...
 Shop:AddButton("Tomoe Ring [ $500k Beli ]",function()
     local args = {
         [1] = "BuyItem",
         [2] = "Tomoe Ring"
     }
 ...
 Shop:AddSeperator("👾 Race & etc 👾")
 Shop:AddButton("Race Ghoul (Use 2.5K Fragments)",function()
     local args = {
         [1] = "Ectoplasm",
         [2] = "BuyCheck",
         [3] = 4
 ...
 Shop:AddButton("Race Cyborg (Use 2.5K Fragments)",function()
     local args = {
         [1] = "CyborgTrainer",
         [2] = "Buy"
     }
 ...
 Misc:AddSeperator("🗺️ Server - Main 🗺️ ")
...
Misc:AddToggle("Infinite Ability",false,function(infA)
if infA then
...
Misc:AddToggle("Infinite Jump", nil, function(State)
Infinite = State
...
Misc:AddToggle("Graphic",false,function(v)
 ...
 Misc:AddSeperator("⚙️ Misc ⚙️")
    ...
    Misc:AddToggle("Auto Haki", true,function(vu)
   _G.AutoHakiBuso = vu
end)
...
repeat wait() until game:IsLoaded() 
 ...
 Misc:AddToggle("No Clip",_G.NoClip,function()
     _G.NoClip = value
 end)
 
Misc:AddSeperator("👥 Main - Mob 👥")
 ...
 Misc:AddButton("Invisible (lag)",function()
 game.Players.LocalPlayer.Character.LowerTorso.Root:Destroy()
end)
 
 Misc:AddButton("Invisible [Remove]",function()
...
wait(1)
 ...
 Misc:AddDropdown("Selected Codes",{"FUDD10","KittGaming","BIGNEWS","THEGREATACE","SUB2GAMERROBOT_EXP1","StrawHatMaine","Sub2OfficialNoobie","SUB2NOOBMASTER123","Sub2Daigrock","Axiore","TantaiGaming","JCWK","Starcodeheo","Sub2Fer999","Magicbus","Enyu_is_Pro","Bluxxy"},{""},function(value)
     _G.CodeSelect = value
 end)
 ...
 Misc:AddSeperator("✈️ Boost FPS  ✈️")
...
Misc:AddToggle("Super FPS boost",false,function(value)
...
if not game:GetService("UserInputService").TouchEnabled and not game:GetService("UserInputService").KeyboardEnabled == false then
 Misc:AddSlider("FPS Lock",0,499,60,function(K)setfpscap(tonumber(K));
 end)
 else
Misc:AddSlider("FPS Lock",0,499,60,function(K)setfpscap(tonumber(K));
 end)
 ...
 Misc:AddButton("FPS delete color",function()
...
v.Material = "Plastic"
 ...
 Misc:AddButton("FPS Fast Mode",function()
for _,v in pairs(workspace:GetDescendants()) do
if v.ClassName == "Part"
or v.ClassName == "SpawnLocation"
or v.ClassName == "WedgePart"
